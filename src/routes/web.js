...
const initWebRouter = (app) => {
    ...
    router.get('/verifyorder', userController.tronverify);
    ...
    router.get('/wallet/tronrecharge', middlewareController, homeController.tronRecharge);
    ...
    router.post('/api/webapi/recharge/tronupdate', middlewareController, userController.tronupdate); // register
